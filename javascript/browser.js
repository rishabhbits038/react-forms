...
/***/ function(module, exports, __webpack_require__) {
	...
	var _smartFormPage = __webpack_require__(157);

	var _smartFormPage2 = _interopRequireDefault(_smartFormPage);

	_react2["default"].render(_react2["default"].createElement(_smartFormPage2["default"], null), document.body);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var formData = __webpack_require__(158);

	var SmartForm = __webpack_require__(159);
	var SmartFormPage = React.createClass({
		displayName: 'SmartFormPage',

		handleOnClick: function handleOnClick(data) {
			console.log(data);
		},
		render: function render() {
			return React.createElement(SmartForm, { data: formData.data, onClick: this.handleOnClick });
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var SmartInput = __webpack_require__(160);
	var SmartDropDownSelect = __webpack_require__(161);
	var SmartButton = __webpack_require__(166);
	var SmartCheckbox = __webpack_require__(167);
	var SmartRadio = __webpack_require__(168);
	var SmartFileInput = __webpack_require__(169);
	   ...
	   */
		...
		getFormJSON: function getFormJSON() {
			...
			if (this.props.data.length === 0 && this.props.dataUrl) {
				SmartService.get(this.props.dataUrl).end(function (err, res) {
					var json = res.text;
		...
		getMapIndexToKey: function getMapIndexToKey(formJSON) {
			var map = {};
			formJSON.map(function (item, index) {
				map[item['elementId']] = index;
			});
			return map;
		},
		isEmptyJSON: function isEmptyJSON(obj) {
		...
		handleButtonClick: function handleButtonClick(elementId, event) {
			this.setState({
				clickedSubmit: true
			});
			var flag = true;
		...
		render: function render() {
			...
			var arr = this.state.formJSON.map(function (item) {
				var Comp = Components[item["type"]];
				if (Comp === undefined) {
					console.log('Smart Form Component ' + item["type"] + " is not found");
					return null;
				}
				if (item["type"] === 'SmartButton') return React.createElement(Comp, _extends({}, item, {
					onClick: _this.handleButtonClick }));else return React.createElement(Comp, _extends({}, item, { onChange: _this.handleChange, clickedSubmit: _this.state.clickedSubmit
				}));
			});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SmartInput = _react2['default'].createClass({
	   ...
	   */
			clickedSubmit: _react2['default'].PropTypes.func
		},
		...
		isValidValue: function isValidValue(mandatory, value, regex) {
			var error = null;
			if (mandatory === true) {
				if (value) {
					if (value === "") error = true;else {
		...
		render: function render() {
			...
			return _react2['default'].createElement(
				...
				_react2['default'].createElement('input', { type: 'text', className: "inputBox " + this.state.defaultClass + " " + this.props.className, placeholder: this.props.placeholder, value: this.state.value,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SmartDropDownSelect = React.createClass({
	    ...
	    handleOnChange: function handleOnChange(value, values) {
	        var result = {};
	        var elementId = this.props.elementId;
	        var statusType = null;
	        var valueComp = null;
	    ...
	    render: function render() {
	        var optionsArray = this.props.value.map(function (item) {
	            var temp = {};
	        ...
	        return React.createElement(
	            'div',
	            { className: 'commonFormComponents' },
	            ...
	            React.createElement(
	                'div',
	                { className: 'section' },
	                React.createElement(_reactSelect2['default'], { multi: this.props.multiSelect, value: this.state.value, options: optionsArray, onChange: this.handleOnChange })
	            ),
	            error
	        );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RadioButton = React.createClass({
	    ...
	    render: function render() {
	        ...
	        var radioArray = this.props.value.map(function (item, index) {
	            var temp = {};
	            if (typeof item == 'object') {
	                for (var key in item) {
	                    temp['value'] = key;
	...
	var SmartInput = _react2['default'].createClass({
	    ...
	    render: function render() {
	        ...
	        if (this.state.error && this.props.clickedSubmit) {
	            error = _react2['default'].createElement(
	                'div',
	                { className: 'errorContainerFileInput' },
	                ' Invalid ',
	                this.props.label
	            );
	        }
	        ...
	        return _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	                'span',
	                { className: 'fileUploadName' },
	                this.state.value ? _underscore2['default'].pluck(this.state.value, 'name').toString() : "Select a file..."
	            ),
	            _react2['default'].createElement(
	                'div',
	                { className: this.state.defaultClass + " " + this.props.theme, onClick: this.handleOnClick },
	                this.props.label,
	                _react2['default'].createElement('input', { type: 'file', ref: 'fileInput', multiple: this.props.multiSelect,
